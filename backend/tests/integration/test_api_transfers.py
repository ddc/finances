...
class TestTransferCRUD:
    def test_create_transfer_as_admin(self, admin_client, bank):
    ...
    def test_create_transfer_as_viewer_denied(self, viewer_client, bank):
    ...
    def test_list_transfers(self, admin_client, bank):
        admin_client.post(
            f"{TRANSFER_URL}/",
            {
                "transfer_date": "2026-01-02",
...
class TestTransferFileUpload:
    def test_upload_transfer_file(self, admin_client, bank):
        data = {
            "transfer_date": "2026-01-02",
            "bank": str(bank.id),
            "amount_brl": "5890.00",
    ...
    def test_download_transfer_file(self, admin_client, bank):
        data = {
            "transfer_date": "2026-01-02",
            "bank": str(bank.id),
            "amount_brl": "5890.00",
    ...
    def test_download_nonexistent_file_returns_404(self, admin_client, bank):
        data = {
            "transfer_date": "2026-01-02",
            "bank": str(bank.id),
            "amount_brl": "5890.00",
