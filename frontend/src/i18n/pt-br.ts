export default {
  ...
  expenses: {
    ...
    paymentFile: "Comprovante de Pagamento",
  ...
  deposits: {
    ...
    nfeFile: "NFE",
    invoiceFile: "Fatura",
    transactionFile: "Comprovante da Transação",
    conversionFile: "Comprovante de Conversão",
    uploadNfe: "Anexar NFE",
    uploadInvoice: "Anexar Fatura",
    uploadTransaction: "Anexar Comprovante da Transação",
    uploadConversion: "Anexar Comprovante de Conversão",
    viewFile: "Ver",
    downloadFile: "Baixar",
    companies: {
      OTHER: "Outros",
